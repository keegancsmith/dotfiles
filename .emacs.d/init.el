...
(defun consult-git ()
  ...
  (interactive)
  (let* ((default-directory (funcall consult-project-function))
...
(use-package org
  ...
  (setq current-journal-filename "~/org-files/journals/2022/2022-05-May.org")
  ...
  (setq
   ...
   org-refile-targets '((("~/org-files/work.org" "~/org-files/home.org" "~/org-files/backlog.org" "~/org-files/notes.org" "~/org-files/learn.org") :maxlevel . 1)
                        (("~/org-files/journals/2022/2022-05-May.org") :maxlevel . 1))
